  ...
  var changeCanvasSize = function(ctl){
    ...
    var Actions = function() {
      ...
      var tool_buttons = [
        ...
        // Removed relevant markup lookup so we can retain keyboard shortcuts
        {fn: deleteSelected, key: ['del/backspace', true]},
        ...
        // Removed relevant markup lookup so we can retain keyboard shortcuts
        {fn: clickUndo, key: modKey + 'z'},
        {fn: clickRedo, key: ['y', true]},
        {fn: cutSelected, key: [modKey+'x', true]},
        {fn: copySelected, key: modKey+'c'},
        {fn: pasteSelected, key: modKey+'v'},
